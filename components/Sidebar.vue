    ...
    <aside :class="[
      ...
      <div class="flex flex-col h-full grow">
        ...
        <div class="flex-1 overflow-y-auto ">
          <UNavigationMenu orientation="vertical" class="px-2" :items="navLinks" :collapsed="isCollapsed" :ui="{
            linkLeadingIcon: isCollapsed
              ? 'text-2xl flex justify-center items-center w-full min-h-[48px]'
              : 'text-lg'
          }" />
        </div>
        ...
        <div class="border-t ring-default py-2">
          ...
          <div class="mb-2 flex justify-center">
            <UButton :icon="$colorMode.value === 'light' ? 'i-heroicons-moon' : 'i-heroicons-sun'" variant="ghost"
              color="gray" aria-label="Toggle theme" @click="toggleColorMode" />
          ...
          <UButton block variant="soft" color="gray" @click="toggleSidebar"
            :icon="isCollapsed ? 'i-heroicons-arrow-right' : 'i-heroicons-arrow-left'" size="sm">
